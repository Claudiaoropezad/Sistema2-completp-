    ...
    public class RegisterModel : PageModel
    {
        ...
        public void OnGet(int id)
        {
            ...
            if (_dataInput != null || _dataUser1 != null || _dataUser2 != null)
            {
                ...
                {
                    if (_dataUser1 != null || _dataUser2 != null)//ultimo error
                    {
                        if (_dataUser2 != null)
        ...
        private async Task<bool> SaveAsync()
        {
            ...
            else
            {
                ...
                //_dataInput.ErrorMessage = "Seleccione un role";
                valor = false;
            }
        ...
        private async Task<bool>UpdateAsync()
        {
            ...
            using (var transaction = _context.Database.BeginTransaction())
                ...
                try
                {
                        ...
                        {
                            imageByte = await _uploadimage.ByteAvatarImageAsync(Input.AvatarImage, _environment, "image/image/default.png");
                        }
                        var t_user = new TUsers
                        {
                            ID= _dataUser2.Id,
